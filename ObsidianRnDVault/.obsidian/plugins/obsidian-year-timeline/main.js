...
// src/components/settings-tab-component.ts
var SettingsTabComponent = class extends import_obsidian.PluginSettingTab {
  constructor(app, plugin) {
    super(app, plugin);
    this.plugin = plugin;
    this.previewDate = (0, import_moment.default)().format("YYYY-06-01");
  }
  display() {
  ...
  displayPreview() {
    ...
    containerEl.createDiv({
      ...
      attr: {
        "data-timeline": (0, import_moment.default)(this.previewDate).format("DDD"),
    ...
    containerEl.createDiv({
      ...
      this.previewDate = (0, import_moment.default)(date).format("YYYY-MM-DD");
      this.display();
    });
  }
  displaySnippet() {
  ...
  displayDayMarkerSettings() {
    ...
    new import_obsidian.Setting(containerEl).setName("Marker").addDropdown(
      (component) => component.addOption("line", "Line").addOption("circle", "Circle").addOption("emoji", "Emoji or symbol").setValue(this.plugin.settings.dayMarker.style).onChange(async (value) => {
    ...
    switch (this.plugin.settings.dayMarker.style) {
      case "line": {
        new import_obsidian.Setting(containerEl).setName("Line color").addColorPicker(
          (component) => component.setValue(this.plugin.settings.dayMarker.line.color).onChange(async (value) => {
            this.plugin.settings.dayMarker.line.color = value;
            await this.plugin.saveSettings();
            this.plugin.reload();
          })
        ).addExtraButton(
          (component) => component.setIcon("lucide-rotate-ccw").setTooltip("Reset to default").onClick(async () => {
        ...
        new import_obsidian.Setting(containerEl).setName("Line width").addSlider(
          (component) => component.setLimits(1, 50, 0.5).setDynamicTooltip().setValue(this.plugin.settings.dayMarker.line.width).onChange(async (value) => {
      ...
      case "circle": {
        new import_obsidian.Setting(containerEl).setName("Circle color").addColorPicker(
          (component) => component.setValue(this.plugin.settings.dayMarker.circle.color).onChange(async (value) => {
        ...
        new import_obsidian.Setting(containerEl).setName("Circle border color").addColorPicker(
          (component) => component.setValue(this.plugin.settings.dayMarker.circle.border).onChange(async (value) => {
        ...
        new import_obsidian.Setting(containerEl).setName("Circle border thickness").addSlider(
          (component) => component.setLimits(1, 50, 0.5).setDynamicTooltip().setValue(this.plugin.settings.dayMarker.circle.borderWidth).onChange(async (value) => {
        ...
        new import_obsidian.Setting(containerEl).setName("Circle radius").addSlider(
          (component) => component.setLimits(1, 200, 1).setDynamicTooltip().setValue(this.plugin.settings.dayMarker.circle.radius).onChange(async (value) => {
      ...
      case "emoji": {
        new import_obsidian.Setting(containerEl).setName("Emoji or symbol character").addText(
          (component) => component.setValue(this.plugin.settings.dayMarker.emoji.character).onChange(async (value) => {
        ...
        new import_obsidian.Setting(containerEl).setName("Adjust emoji or symbol size").addSlider(
          (component) => component.setLimits(0.15, 3, 0.05).setDynamicTooltip().setValue(this.plugin.settings.dayMarker.emoji.scale).onChange(async (value) => {
        ...
        new import_obsidian.Setting(containerEl).setName("Adjust emoji or symbol X offset").addSlider(
          (component) => component.setLimits(-100, 100, 1).setDynamicTooltip().setValue(this.plugin.settings.dayMarker.emoji.offsetX).onChange(async (value) => {
        ...
        new import_obsidian.Setting(containerEl).setName("Adjust emoji or symbol Y offset").addSlider(
          (component) => component.setLimits(-100, 100, 1).setDynamicTooltip().setValue(this.plugin.settings.dayMarker.emoji.offsetY).onChange(async (value) => {
  ...
  displayTimelineSettings() {
    ...
    new import_obsidian.Setting(containerEl).setName("Timeline style").addDropdown(
      (component) => component.addOption("solid", "Solid months").addOption("gradient", "Gradient").addOption("custom", "Custom SVG").setValue(this.plugin.settings.timeline.style).onChange(async (value) => {
  ...
  displayTimelineMonthSettings() {
    ...
    Object.entries(monthSettings).forEach(async ([month, { name, color }]) => {
      let colorPicker;
      let nameField;
      new import_obsidian.Setting(containerEl).setName(name).addText(
        (component) => nameField = component.setValue(name).onChange(async (value) => {
          this.plugin.settings.timeline.solid[month].name = value;
          await this.plugin.saveSettings();
          this.plugin.reload();
        })
      ).addColorPicker(
        (colorComponent) => colorPicker = colorComponent.setValue(color).onChange(async (value) => {
          this.plugin.settings.timeline.solid[month].color = value;
          await this.plugin.saveSettings();
          this.plugin.reload();
        })
      ).addExtraButton(
        (component) => component.setIcon("lucide-rotate-ccw").setTooltip("Reset to default").onClick(() => {
  ...
  displayTimelineGradientSettings() {
    ...
    if (gradient.colors.length) {
      gradient.colors.forEach((colorSettings, index) => {
        ...
        new import_obsidian.Setting(containerEl).setName("#" + (index + 1)).addColorPicker(
          (component) => component.setValue(color).onChange(async (value) => {
            this.plugin.settings.timeline.gradient.colors[index].color = value;
            await this.plugin.saveSettings();
            this.plugin.reload();
          })
        ).addSlider(
          (component) => component.setValue(offset).setDynamicTooltip().setLimits(0, 100, 0.5).onChange(async (value) => {
            this.plugin.settings.timeline.gradient.colors[index].offset = value;
            await this.plugin.saveSettings();
            this.plugin.reload();
          })
        ).addExtraButton(
          (component) => component.setIcon("lucide-trash-2").setTooltip("Remove").onClick(async () => {
            this.plugin.settings.timeline.gradient.colors = this.plugin.settings.timeline.gradient.colors.filter((someSettings) => someSettings != colorSettings);
            await this.plugin.saveSettings();
            this.plugin.reload();
            this.display();
          })
  ...
  displayTimelineCustomSettings() {
    const { containerEl } = this;
    new import_obsidian.Setting(containerEl).addTextArea((component) => {
      var _a, _b, _c;
      component.inputEl.style.width = "100%";
      component.inputEl.style.resize = "none";
      component.inputEl.rows = 10;
      (_c = (_b = (_a = component.inputEl.parentElement) == null ? void 0 : _a.parentElement) == null ? void 0 : _b.querySelector(".setting-item-info")) == null ? void 0 : _c.remove();
      component.setValue(this.plugin.settings.timeline.custom).onChange(async (value) => {
  ...
  displayCustomMarkerSettings() {
    ...
    if (this.plugin.settings.dayMarker.style === "emoji") {
      containerEl.createDiv({
        ...
        text: `Day marker is set to 'Emoji or symbol'.
    ...
    if (this.plugin.settings.customMarkers.length) {
      this.plugin.settings.customMarkers.forEach((marker, index) => {
        ...
        new import_obsidian.Setting(containerEl).setName("#" + (index + 1)).addText(
          (component) => component.setValue(character).onChange(async (value) => {
          ...
          component.setValue(date).onChange(async (value) => {
            this.plugin.settings.customMarkers[index].date = (0, import_moment.default)(value).format("YYYY-MM-DD");
            await this.plugin.saveSettings();
            this.plugin.reload();
          });
        }).addExtraButton(
          (component) => component.setIcon("lucide-trash-2").setTooltip("Remove").onClick(async () => {
            this.plugin.settings.customMarkers = this.plugin.settings.customMarkers.filter((someMarker) => someMarker != marker);
            await this.plugin.saveSettings();
            this.plugin.reload();
            this.display();
          })
    ...
    containerEl.createDiv({
      ...
      const date = (0, import_moment.default)().format("YYYY-MM-DD");
      const character = "\u{1F389}";
  ...
  displayDailyNotesIntegrationSettings() {
    ...
    new import_obsidian.Setting(containerEl).setName("Daily Notes integration").setDesc("Navigate between daily notes by clicking on the timeline").addToggle(
      (component) => component.setValue(this.plugin.settings.dailyNoteIntegration.enabled).onChange(async (value) => {
...
function generateBaseStyle(settings) {
  const range = Array.from({ length: Number((0, import_moment2.default)("2023-12-31").format("DDD")) }, (_, i) => i);
  return `
    [data-timeline] {
      position: relative;
...
function generateMainSvg(settings) {
...
function generateTimelineSolidSvg(settings) {
...
function generateTimelineGradientSvg(settings) {
  return encodeURIComponent(`
    <svg
      xmlns='http://www.w3.org/2000/svg'
      viewBox='0 -100 3760 200'>
  ...
  switch (settings.dayMarker.style) {
    ...
    case "circle": {
      return encodeURIComponent(`
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 -100 3760 200'>
          ${generateCustomMarkers(settings)}
          <g transform='translate(${dayIndex * 10.3},12)'>
            <circle
    ...
    case "emoji": {
      return encodeURIComponent(`
        ...
        >
          <g transform='translate(${dayIndex * 10.3},0)'>
            <text fill="red" style="font-size: 100px" transform="scale(${settings.dayMarker.emoji.scale})" transform-origin="50 50">${settings.dayMarker.emoji.character}</text>
          </g>
        </svg>
      `);
    }
  }
  function generateCustomMarkers(settings2) {
    return `
      <g style="font-size:100px;" text-anchor="middle">
        ${settings2.customMarkers.map(({ date, character }) => `
          <text fill="white" x="${Number((0, import_moment2.default)(date).format("DDD")) * 10.3}" y="-5">${character}</text>
        `)}
      </g>
    `;
  }
...
var dailyNotesSettings = {
  folder: "",
  format: "YYYY-MM-DD"
};
var isHovering = false;
var timelineTooltipEl;
function registerEventListeners(app, plugin) {
  let mouseMoveTimer;
  plugin.registerDomEvent(document, "mousemove", (e) => {
    if (!plugin.settings.dailyNoteIntegration.enabled)
      return;
    if (isHovering)
      endHover();
  ...
  plugin.registerDomEvent(document, "click", (e) => {
    ...
    if (!plugin.settings.dailyNoteIntegration.enabled)
      return;
    if ((_a = e.target) == null ? void 0 : _a.matches("[data-timeline]")) {
      e.preventDefault();
      const activeDate = (0, import_moment3.default)(
        (_b = app.workspace.getActiveFile()) == null ? void 0 : _b.name.replace(/.md$/, ""),
        dailyNotesSettings.format
      );
      const newDate = (0, import_moment3.default)(activeDate, "DDD").dayOfYear(getMouseDayOfYear(e)).format(dailyNotesSettings.format);
      const dailyNotesFolder = app.vault.getAbstractFileByPath(
        (0, import_obsidian2.normalizePath)(dailyNotesSettings.folder)
      );
      let dailyNote = null;
...
async function setup(app, plugin) {
  var _a, _b, _c;
  if (!plugin.settings.dailyNoteIntegration.enabled)
    return;
  await new Promise((resolve) => setTimeout(resolve, 2e3));
  const { folder, format } = ((_c = (_b = (_a = window.app.internalPlugins) == null ? void 0 : _a.getPluginById("daily-notes")) == null ? void 0 : _b.instance) == null ? void 0 : _c.options) || {};
  dailyNotesSettings = {
...
function startHover(e) {
  var _a;
  if (!isHovering && ((_a = e.target) == null ? void 0 : _a.matches("[data-timeline]"))) {
    hideTooltip();
    isHovering = true;
    const dayOfYear = (0, import_moment3.default)(getMouseDayOfYear(e), "DDD");
...
function hideTooltip() {
  timelineTooltipEl == null ? void 0 : timelineTooltipEl.remove();
}
function getMouseDayOfYear(e) {
  var _a;
  const rect = (_a = e.target) == null ? void 0 : _a.getBoundingClientRect();
...
// src/year-timeline-plugin.ts
var YearTimelinePlugin = class extends import_obsidian3.Plugin {
  async onload() {
    ...
    this.app.workspace.on("css-change", () => {
      ...
      cssChangeTimer = setTimeout(() => this.reload(), 1e3);
    });
    setup(this.app, this);
  ...
  onunload() {
    var _a;
    (_a = document.getElementById("timeline-plugin-style")) == null ? void 0 : _a.remove();
  }
  reload() {
    this.onunload();
    document.head.appendChild(generateStyles(this.settings));
