 ...
 * 			"System/scripts/functions/SvgProgressBar.mjs"
 * 		);
	...
	createSVG(tF) {
		...
		const svgContent = `<svg width="${svgCalc.tot_width}" height="${
			...
			tF.title
				...
				: ""
		}<g fill="#fff" text-anchor="middle" font-family="DejaVu Sans,Verdana,Geneva,sans-serif" font-size="${svgCalc.font_size}"><text x="${
			svgCalc.x_txt
		}" y="${svgCalc.y_txt_shadow}" fill="#010101" fill-opacity=".3">${
			svgCalc.txt_prog
